...
awful.util.tagnames = { "main", "www", "music", "office", "work","msg","7" }
...
--Spotify
    awful.key({"Control"},"F10",nil,
             {description = "play/pause", group ="spotify"}),
    awful.key({"Control"},"F9",nil,
             {description = "previous track", group ="spotify"}),
    awful.key({"Control"},"F11",nil,
             {description = "next track", group ="spotify"}),



--Shutdown: Fake hotkeys
    awful.key({"Control"},"F1",nil,
...
--Hide Conky area
    ...
    myverticalwibox.visible = not myverticalwibox.visible end,
    {description = "Hide Conky", group = "hotkeys"}),
    ...
    awful.key({altkey},"m",nil,
             {description = "mute/unmute volume", group ="hotkeys"}),
    awful.key({modkey,altkey},"m",nil,
             {description = "volume 100%", group ="hotkeys"}),

    awful.key({altkey,"Control"},"Up",nil,
...
awful.rules.rules = {
    ...
    { rule = { class = "Gimp", role = "gimp-image-window" },
          properties = { maximized = true, screen = 1, tag= awful.util.tagnames[7] } },
   ...
   { rule = { class = "Foxit Reader"},
    properties = { tag = "office", switchtotag = true } },
        { rule = { name = "[Ss]potify*" },
   properties = { tag =  "music", screen=1, switchtotag = true   } },
   ...
   --                for s = 1, 2 do
	...
	properties = { dockable = true, own_window_type = "dock" ,border_width = 0 } }
  }
-- }}}
...
if screen.count() == 2
	then
        	myverticalwibox = awful.wibar({ position = "left", screen = 2,border_width=0, width = 312,height=710})

  	else
        	myverticalwibox = awful.wibar({ position = "left", screen = 1,border_width=0, width = 312,height=710})
end
  -- myverticalwibox = awful.wibar({ position = "left", screen = 2,border_width=0, width = 312,height=710})
